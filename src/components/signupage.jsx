  ...
  return (
    ...
    <section className="first flex justify-center items-center">
      <div className="texts flex flex-col justify-center gap-10">
        ...
        <ul className='flex flex-col gap-4'>
          <li className='flex gap-3'><img src="/images/icon-list.svg" alt="list" /><span>Product discovery and building what matters</span></li>
          <li className='flex gap-3'><img src="/images/icon-list.svg" alt="list" /><span>Measuring to ensure updates are a success</span></li>  
          <li className='flex gap-3'><img src="/images/icon-list.svg" alt="list" /><span>And much more!</span></li>
        </ul>
    ...
    <section className="second">
      <div className="img height-[550px]">
        <img src="/images/illustration-sign-up-desktop.svg" alt="background" className='h-[550px] md:block hidden' />
        <img src="/images/illustration-sign-up-mobile.svg" alt="background" className='md:hidden min-w-[300px] block' />
      </div>
    </section>
  </main>
  )
